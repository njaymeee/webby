      ...
      <main className="main">
        ...
        <section className="section-socials">
          ...
          <div className="socials-grid">
            <a href="#" className="social-card spotify">
            ...
            <a href="#" className="social-card pinterest">
            ...
            <a href="#" className="social-card x-twitter">
          ...
          <div className="about-grid">
            <div className="about-block">
              ...
              <div className="hobby-list">
                ...
                <div className="hobby-item">✈️ Traveling</div>
                <div className="hobby-item">🎬 Watching Films</div>
              </div>
            </div>
            <div className="about-block">
              ...
              <div className="skills-list">
                <div className="skill-item">
                  <span className="skill-label">React / TypeScript</span>
                  <div className="skill-bar"><div className="skill-fill" style={{width: '75%'}} /></div>
                </div>
                <div className="skill-item">
                  <span className="skill-label">CSS / Design</span>
                  <div className="skill-bar"><div className="skill-fill" style={{width: '85%'}} /></div>
                </div>
                <div className="skill-item">
                  <span className="skill-label">Photography</span>
                  <div className="skill-bar"><div className="skill-fill" style={{width: '70%'}} /></div>
                </div>
                <div className="skill-item">
                  <span className="skill-label">Music Curation</span>
                  <div className="skill-bar"><div className="skill-fill" style={{width: '90%'}} /></div>
                </div>
              </div>
            </div>
          </div>
